...
# print('Overall accuracy: %.4f'%np.mean(accuracy_n))
...
# Train on 01 Test on 02

# 4-class classification
X_train = np.load("01_X.npy")
y_train = np.load("01_y.npy")

X_test = np.load("02_X.npy")
y_test = np.load("02_y.npy")
