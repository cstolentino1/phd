...
# # Load the video
# filename = '../data/video/phase3/03_01.mp4'
...
# np.save("01_X_frames.npy", X)
# np.save("01_y_frames.npy", y)

X = np.load('01_X_frames.npy', allow_pickle='TRUE').item()
y = np.load('01_y_frames.npy', allow_pickle='TRUE').item()
