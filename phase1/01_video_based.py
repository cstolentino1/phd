...
# Load video
filename = '../data/video/phase1/01_01.mkv'
...
# Peak finding
peaks, _ = find_peaks(spec_flux, height = 24, distance = 40)
...
np.save('01_video_based_plucking_positions.npy', PP)
